                ...
                <Form.Group className="mb-3" controlId="formName">
                  ...
                  <Container id="widhtStyle">
                    <Form.Control
                      ...
                      type="text"
                      placeholder="Escriba su respuesta"
                      onChange={({ target }) => setNombApellidoAnalista(target.value)}
                      required
                    />
                  </Container>
                </Form.Group>
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaComunicaEfectiva(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaRecibirCriticas(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaAnticipaHechos(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaMuestraIniciativa(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaProponerSoluciones(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaDeterminacion(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaNegocio(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaNuevosDesafios(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaDesicionesCorrectas(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaResponsableResultados(target.value)}
                    >
                      <Form.Check
                        style={{ padding: 12 }}
                        label="No satisfactorio"
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaPropiasDesiciones(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaMetodologia(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaComunicarseLibertad(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaReconocerEsfuerzo(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaGestionarCorrectamente(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaCapacidadAnalitica(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaInfluirPositivamente(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaDesempeño(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaConocimientosTecnicos(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
                ...
                <Container id="checkStyle">
                  {["radio"].map((type) => (
                    <div
                      ...
                      className="mb-3"
                      id="checkStyle"
                      onChange={({ target }) => setAnalistaConocimientosNegocio(target.value)}
                    >
                      {" "}
                      <Form.Check
                        style={{ padding: 12 }}
